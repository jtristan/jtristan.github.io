...
{\em Transfer Learning and Invariance for Bayesian Optimization.} \hfill {\bf 2021}\\
{\bf Schiller Institute (co-PI)}: \$45,500
\vspace{-.4cm}

{\em Hierarchical Gaussian Process Regression for Meta-Learning of Molecular Geometry Optimization.} \hfill {\bf 2021}\\
{\bf National Science Foundation (PI)}: \$963,189
\vspace{-.4cm}

{\em SHF: Medium: Formally Verified Compilation of Probabilistic Programs.} \hfill {\bf 2021}\\
{\bf Oracle (PI)}: \$50,000
\vspace{-.4cm}

{\em Formal Semantics and Verified Parsing for an Inference Language.} \hfill {\bf 2020}\\
...
Daniel Huang (2020-2021), now assistant professor at San Francisco State University.

\section{\sc Research associates}

Caleb Miller (2021-present).

Julian Asilis (2021-2022), now Ph.D. student at the University of Chicago.

\section{\sc Senior Thesis}

Jieqi Di, Scholar of the College, 2021-2022

Ronan Manvelian, 2021-2022

Gina Chun, 2021-2022

Darius Russell Kish, 2020-2021, now a Ph.D. student at Harvard University.

Bryan Ward, 2020-2021, now a research engineer at the Flatiron institute.

Emily Walker, 2020-2021

\section{\sc Internships}

 Changee Park (KAIST), Joe Tassarotti
(Harvard), Daniel Huang (2x) (Harvard), Manzil Zaheer (2x) (CMU), Sam
Anzaroot (Umass Amherst), Jay-Yoon Lee (CMU) ,Koundinya Vajha
(U. Pittsburgh), Hao Wu (Northeastern), Chanwei Hu (Duke), Aishwaria
Kamath (UMass), Rashika Mishra (Ut Dallas).
