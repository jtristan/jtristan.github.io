...
Fabien Zaiser (Oxford), Anastasiya Kravchuk-Kirilyuk (Harvard),
Christopher Brix (Aachen), Shadaj Laddad (Berkeley), Ananya Barthakur
(Boston College), Gina Chun (Boston College),Changee Park (KAIST), Joe
Tassarotti (Harvard), Daniel Huang (2x) (Harvard), Manzil Zaheer (2x)
(CMU), Sam Anzaroot (Umass Amherst), Jay-Yoon Lee (CMU) ,Koundinya
Vajha (U. Pittsburgh), Hao Wu (Northeastern), Chanwei Hu (Duke),
Aishwaria Kamath (UMass), Rashika Mishra (Ut Dallas).
